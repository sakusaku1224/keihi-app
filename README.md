...
ドラッグ&ドロップでアップロードした領収書を見ながら入力・修正できるため、OCRの読み取り結果の確認や誤入力の修正がスムーズに行えます。  
...
エラーが出た時点でほとんどのユーザーは「何を直すべきか」を理解しています。（特にストレスと感じる人は少ないかもしれませんが）入力を始めているのにエラー表示が残り続けるより、速やかに消える方が良いと考えたからです。
